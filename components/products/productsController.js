...
router.get("/", (req, res, next) => {
  apicaller
    .callApi(`products/paramsApi?page=${req.query.page}`, "GET", null)
...
router.get("/detail", (req, res, next) => {
  apicaller
    .callApi(`products/api?id=${req.query.id}`, "GET", null)
...
router.get("/search", (req, res, next) => {
  apicaller
    .callApi(
      `products/paramsApi?search=${req.query.search}&page=${req.query.page}`,
      "GET",
      null
    )
    .then(function (responseData) {
